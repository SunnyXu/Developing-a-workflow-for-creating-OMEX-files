...
te.saveToFile("Chrobak2011-Fig7A.sedml", sed)
...
sedml_filenames = ["Chrobak2011-Fig7A.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000815-Fig7A.omex")
