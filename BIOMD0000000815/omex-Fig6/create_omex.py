...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Chrobak2011-Fig6.sedml")
...
te.saveToFile("Chrobak2011-Fig6.sedml", sed)
...
sedml_filenames = ["Chrobak2011-Fig6.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000815-Fig6.omex")
