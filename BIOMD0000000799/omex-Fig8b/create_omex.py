...
te.saveToFile("Cucuianu2010-Fig8b.sedml", sed)
...
sedml_filenames = ["Cucuianu2010-Fig8b.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000799-Fig8b.omex")
