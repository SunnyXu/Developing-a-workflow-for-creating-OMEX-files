...
te.saveToFile("Cucuianu2010-Fig8a.sedml", sed)
...
sedml_filenames = ["Cucuianu2010-Fig8a.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000799-Fig8a.omex")
