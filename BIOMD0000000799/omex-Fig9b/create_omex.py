...
te.saveToFile("Cucuianu2010-Fig9b.sedml", sed)
...
sedml_filenames = ["Cucuianu2010-Fig9b.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000799-Fig9b.omex")
