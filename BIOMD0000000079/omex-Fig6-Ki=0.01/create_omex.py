...
te.saveToFile("BIOMD0000000079_url-Fig6-Ki=0.01.sedml", sed)
...
sedml_filenames = ["BIOMD0000000079_url-Fig6-Ki=0.01.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000079-Fig6-Ki=0.01.omex")
