...
sedml = libsedml.readSedMLFromFile("../old_SEDML/BIOMD0000000079_url.sedml")
...
sedml_filenames = ["BIOMD0000000079_url.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000079-Fig3.omex")
