...
te.saveToFile("BIOMD0000000079_url-Fig4-V4=1.2.sedml", sed)
...
sedml_filenames = ["BIOMD0000000079_url-Fig4-V4=1.2.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000079-Fig4-V4=1.2.omex")
