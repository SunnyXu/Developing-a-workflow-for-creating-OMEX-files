...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Chen2011_2.sedml")
...
curve.setName("Relative Superior Species")
curve = plot.getCurve(0)
curve.setStyle("solid_green")
curve.setName("Relative Inferior Species")
...
mod1.setSource("Chen2011_2.xml")

sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Chen2011_2-Fig4B.sedml", sed)
...
sedml_filenames = ["Chen2011_2-Fig4B.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000795-Fig4B.omex")
