...
te.saveToFile("Chen2011_2-Fig4A.sedml", sed)
...
sedml_filenames = ["Chen2011_2-Fig4A.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000795-Fig4A.omex")
