...
te.saveToFile("Chen2011_1swapped-Fig3C.sedml", sed)
...
sedml_filenames = ["Chen2011_1swapped-Fig3C.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000793-Fig3C_curated.omex")
