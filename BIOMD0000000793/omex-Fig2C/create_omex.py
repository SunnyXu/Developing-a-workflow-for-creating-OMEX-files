...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Chen2011_1.sedml")
...
mod1.setSource("Chen2011_1.xml")


sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Chen2011_1-Fig2C.sedml", sed)
...
sedml_filenames = ["Chen2011_1-Fig2C.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000793-Fig2C_curated.omex")
