...
te.saveToFile("Chen2011_1swapped-Fig3A.sedml", sed)
...
sedml_filenames = ["Chen2011_1swapped-Fig3A.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000793-Fig3A_curated.omex")
