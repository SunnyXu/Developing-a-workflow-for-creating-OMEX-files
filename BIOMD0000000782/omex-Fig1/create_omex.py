...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Wang2016_3.sedml")
...
mod1.setSource("Wang2016_3.xml")


sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Wang2016_3.sedml", sed)
...
sedml_filenames = ["Wang2016_3.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000782-Fig1.omex")
