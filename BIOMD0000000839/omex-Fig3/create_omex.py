...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Almeida2019-Fig3.sedml")
...
te.saveToFile("Almeida2019-Fig3.sedml", sed)
...
sedml_filenames = ["Almeida2019-Fig3.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000839-Fig3.omex")
