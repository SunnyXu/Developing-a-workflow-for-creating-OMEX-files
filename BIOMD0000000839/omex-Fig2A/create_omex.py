...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Almeida2019.sedml")
...
curve.setStyle("solid_light_green")
curve.setName("ROR")
...
te.saveToFile("Almeida2019-Fig2A.sedml", sed)
...
sedml_filenames = ["Almeida2019-Fig2A.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000839-Fig2A.omex")
