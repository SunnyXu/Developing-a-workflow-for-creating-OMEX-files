...
mod1.setSource("Jena5258.xml")



sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Jena5258.sedml", sed)
...
sedml_filenames = ["Jena5258.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000712-1-Jena5258.omex")
