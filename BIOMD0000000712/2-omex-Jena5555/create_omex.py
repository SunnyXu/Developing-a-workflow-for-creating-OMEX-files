...
mod1.setSource("Jena5555.xml")


sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Jena5555.sedml", sed)
...
sedml_filenames = ["Jena5555.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000712-2-Jena5555.omex")
