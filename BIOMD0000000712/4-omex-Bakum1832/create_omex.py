...
mod1.setSource("Barkum1832.xml")


sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Barkum1832.sedml", sed)
...
sedml_filenames = ["Barkum1832.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000712-4-Barkum1832.omex")
