...
r = te.loads("Alharbi2019TNVM.xml")
...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Alharbi2019TNVM-Fig11.sedml")
...
sedml_filenames = ["Alharbi2019TNVM-Fig11.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000001038.omex")
