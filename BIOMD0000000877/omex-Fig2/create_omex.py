...
sedml = libsedml.readSedMLFromFile("D:/summer-2023/4-pick_models/26-877/files/Ontah2019-Fig2.sedml")
...
mod1.setSource("Ontah2019.xml")

sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Ontah2019-Fig2.sedml", sed)
...
sedml_filenames = ["Ontah2019-Fig2.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000877-Fig2.omex")
