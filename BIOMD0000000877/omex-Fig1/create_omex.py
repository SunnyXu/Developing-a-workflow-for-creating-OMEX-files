...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Ontah2019.sedml")
...
te.saveToFile("Ontah2019-Fig1.sedml", sed)
...
sedml_filenames = ["Ontah2019-Fig1.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000877-Fig1.omex")
