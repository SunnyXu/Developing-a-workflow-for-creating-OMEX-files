...
plot.setName("Figure 2c-f continuous")
...
te.saveToFile("Mwalili2020-Fig2c-f-continuous.sedml", sed)
...
sedml_filenames = ["Mwalili2020-Fig2c-f-continuous.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000964-Fig2c-f-continous.omex")
