...
plot.setName("Figure 2c-f dashed")
...
curve.setStyle("dash_blue")
curve.setName("Susceptible")
curve = plot.getCurve(1)
curve.setStyle("dash_pink")
...
te.saveToFile("Mwalili2020-Fig2c-f-dashed.sedml", sed)
...
sedml_filenames = ["Mwalili2020-Fig2c-f-dashed.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000964-Fig2c-f-dashed.omex")
