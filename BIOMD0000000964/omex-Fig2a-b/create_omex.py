...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Mwalili2020.sedml")
...
te.saveToFile("Mwalili2020-Fig2a-b.sedml", sed)
...
sedml_filenames = ["Mwalili2020-Fig2a-b.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000964-Fig2a-b.omex")
