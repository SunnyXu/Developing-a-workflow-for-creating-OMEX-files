...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Mwalili2020-Fig2c-f.sedml")
...
plot.setName("Figure 2c-f dotted")
...
curve.setStyle("dot_blue")
curve.setName("Susceptible")
curve = plot.getCurve(1)
curve.setStyle("dot_pink")
curve.setName("Exposed")
curve = plot.getCurve(2)
curve.setStyle("dot_black")
curve.setName("Symptomatic")
curve = plot.getCurve(3)
curve.setStyle("dot_red")
curve.setName("Asymptomatic")
...
mod1.setSource("Mwalili2020.xml")

sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Mwalili2020-Fig2c-f-dotted.sedml", sed)
...
sedml_filenames = ["Mwalili2020-Fig2c-f-dotted.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000964-Fig2c-f-dotted.omex")
