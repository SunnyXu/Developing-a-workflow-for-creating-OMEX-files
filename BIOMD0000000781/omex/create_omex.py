...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Wang2016_2.sedml")
...
mod1.setSource("Wang2016_2.xml")

sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Wang2016_2.sedml", sed)
...
sedml_filenames = ["Wang2016_2.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000781-Fig4.omex")
