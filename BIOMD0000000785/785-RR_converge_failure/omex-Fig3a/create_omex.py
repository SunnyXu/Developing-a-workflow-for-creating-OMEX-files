...
te.saveToFile("Sotolongo-Costa2003-Fig3a.sedml", sed)
...
sedml_filenames = ["Sotolongo-Costa2003-Fig3a.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "Sotolongo-Costa2003-Fig3a_curated.omex")
