...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Jenner2019.sedml")
...
mod1.setSource("Jenner2019.xml")


sed = libsedml.writeSedMLToString(sedml)
te.saveToFile("Jenner2019-Fig3-2.sedml", sed)
...
sedml_filenames = ["Jenner2019-Fig3-2.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000850-Fig3-2.omex")
