...
te.saveToFile("iwamoto2010_Fig7.sedml", sed)
...
sedml_filenames = ["iwamoto2010_Fig7.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000939-Fig7.omex")
