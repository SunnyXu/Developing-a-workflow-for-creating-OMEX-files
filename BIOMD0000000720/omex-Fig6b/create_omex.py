...
sedml = libsedml.readSedMLFromFile("../old_SEDML/Yan2012-Fig6.sedml")
...
te.saveToFile("Yan2012-Fig6b.sedml", sed)
...
sedml_filenames = ["Yan2012-Fig6b.sedml"]
archive = build_combine_archive(".", sedml_filenames)
combine_writer.run(archive, ".", "BIOMD0000000720-Fig6b.omex")
